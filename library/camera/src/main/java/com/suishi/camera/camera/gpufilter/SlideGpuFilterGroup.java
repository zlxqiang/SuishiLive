package com.suishi.camera.camera.gpufilter;
    ...
    public void onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                locked = true;
                downX = -1;
                if (offset > DensityUtils.getScreenWidth() / 3) {
                    scroller.startScroll(offset, 0, DensityUtils.getScreenWidth()- offset, 0, 100 * (1 - offset /DensityUtils.getScreenWidth()));
                    needSwitch = true;
                } else {
                    scroller.startScroll(offset, 0, -offset, 0, 100 * (offset / DensityUtils.getScreenWidth()));
                    needSwitch = false;
                }
                break;
        }
