...
Java_com_seu_magicfilter_beautify_MagicJni_jniInitMagicBeautify(JNIEnv *env, jclass instance,
                                                                jobject handler) {
...
JNIEXPORT void JNICALL
Java_com_seu_magicfilter_beautify_MagicJni_jniStartWhiteSkin(JNIEnv *env, jclass instance,
                                                             jfloat whiteLevel) {
...
JNIEXPORT void JNICALL
Java_com_seu_magicfilter_beautify_MagicJni_jniStartSkinSmooth(JNIEnv *env, jclass type,
                                                              jfloat denoiseLevel) {
...
JNIEXPORT void JNICALL
Java_com_seu_magicfilter_beautify_MagicJni_jniUnInitMagicBeautify(JNIEnv *env, jclass instance) {
    MagicBeautify::getInstance()->unInitMagicBeautify();
}

JNIEXPORT jobject JNICALL
Java_com_seu_magicfilter_beautify_MagicJni_jniStoreBitmapData(JNIEnv *env, jclass instance,
                                                              jobject bitmap) {
    return BitmapOperation::jniStoreBitmapData(env, instance, bitmap);
}

JNIEXPORT void JNICALL
Java_com_seu_magicfilter_beautify_MagicJni_jniFreeBitmapData(JNIEnv *env, jclass instance,
                                                             jobject handle) {
