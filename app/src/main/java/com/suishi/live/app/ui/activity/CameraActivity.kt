...
//    }
    ...
    private val previewRequest:CaptureRequest by lazy{
        session.device.createCaptureRequest(CameraDevice.TEMPLATE_PREVIEW).apply {
            addTarget(mCameraView!!.holder.surface)
        }.build()
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mCameraView = (findViewById(R.id.camera_view) as CameraView).apply{
           ...
           // setOnFilterChangeListener(this@CameraActivity)
            holder.addCallback(this@CameraActivity)
    ...
    private fun initializeCamera()=lifecycleScope.launch(Dispatchers.Main){
        ...
        val target=listOf(mCameraView!!.holder.surface,recorderSurface)
    ...
    private suspend fun createCaptureSession(device: CameraDevice,target:List<Surface>,handler: Handler?=null):CameraCaptureSession= suspendCoroutine{
        cont->
    ...
    override fun surfaceCreated(holder: SurfaceHolder) {
        ...
        mCameraView!!.post{ initializeCamera()}
    }
