 ...
 */
package com.swbyte.chat.adapter;
...
import com.swbyte.chat.EaseConstant;
...
import com.swbyte.chat.widget.chatrow.EaseChatRow;
import com.swbyte.chat.widget.chatrow.EaseChatRowText;
import com.swbyte.chat.widget.chatrow.EaseCustomChatRowProvider;
...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getType() == EMMessage.Type.TXT) {
            ...
            }else if (message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_EXT, false)){
