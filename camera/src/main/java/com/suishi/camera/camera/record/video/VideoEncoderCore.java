...
public class VideoEncoderCore {
    ...
    public VideoEncoderCore(int width, int height, int bitRate, String path)
            throws IOException {
        //audio init
        //创建音频的格式,参数 MIME,采样率,通道数
        MediaFormat aFormat = MediaFormat.createAudioFormat(audioMime, sampleRate, channelCount);
        //编码方式
        ...
        //设置bufferSize为AudioRecord所需最小bufferSize的两倍 15360
